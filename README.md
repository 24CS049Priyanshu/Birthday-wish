...
<body>
  ...
  <div class="container hidden" id="message" style="display: none;">
  ...
  <script>
    const messages = [
      ...
      "Love you more than words can ever express. 💫<br><br>Happy Birthday, badi behena! 🎉🎂❤"
    ];
    ...
    function createBurst(btn) {
      ...
      for (let i = 0; i < 5; i++) {
        ...
        burst.style.top = ${Math.random() * -20}px;
